            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <div class="grid grid-cols-3 gap-3 mt-1">
                        <label class="relative cursor-pointer">
                            <input wire:model="themePreference" type="radio" value="light" class="sr-only peer">
                        ...
                        <label class="relative cursor-pointer">
                            <input wire:model="themePreference" type="radio" value="dark" class="sr-only peer">
                            <div class="p-4 rounded-xl border-2 text-center transition peer-checked:border-primary-500 peer-checked:bg-primary-50 dark:peer-checked:bg-primary-900/20 border-gray-200 dark:border-gray-700 hover:border-gray-300 dark:hover:border-gray-600">
                        ...
                        <label class="relative cursor-pointer">
                            <input wire:model="themePreference" type="radio" value="system" class="sr-only peer">
                            <div class="p-4 rounded-xl border-2 text-center transition peer-checked:border-primary-500 peer-checked:bg-primary-50 dark:peer-checked:bg-primary-900/20 border-gray-200 dark:border-gray-700 hover:border-gray-300 dark:hover:border-gray-600">
                ...
                <div>
                    ...
                    <select wire:model="preferredDomain" id="preferredDomain" class="input-field">
                        <option value="">Default ({{ config('nestqr.default_domain', 'nestqr.com') }})</option>
