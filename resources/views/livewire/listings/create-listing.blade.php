<div class="max-w-4xl mx-auto">
    ...
    <form wire:submit="save">
        ...
        <!-- Photos -->
        <div class="card p-6 mb-6">
            <h3 class="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2">Photos</h3>
            <p class="text-sm text-gray-500 dark:text-gray-400 mb-4">Upload up to 10 photos. The first photo will be used as the primary image.</p>

            @error('photos') <div class="mb-4 p-3 bg-red-50 dark:bg-red-900/30 border border-red-200 dark:border-red-800 rounded-lg text-sm text-red-700 dark:text-red-300">{{ $message }}</div> @enderror
            @error('photos.*') <div class="mb-4 p-3 bg-red-50 dark:bg-red-900/30 border border-red-200 dark:border-red-800 rounded-lg text-sm text-red-700 dark:text-red-300">{{ $message }}</div> @enderror
            ...
            <!-- Loading indicator -->
            <div wire:loading wire:target="photos" class="mt-4 flex items-center justify-center">
